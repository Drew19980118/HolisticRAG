...
## News
  ...
  - [2026.08.21] Our paper **"Towards Holistic Knowledge Retrieval for Augmented Generation: Integrating Graph-Grounded and Query-Aligned Knowledge"** has been accepted to EMNLP 2026.
...
For closed-source model, ensure your OpenAI API key and endpoint are set as the environment variable `OPENAI_API_KEY` and `AZURE_OPENAI_ENDPOINT`.
